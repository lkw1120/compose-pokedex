package com.lkw1120.pokedex.core.common
...
object Constants {
    ...
    const val KILOGRAM_FORMAT = "%.1fkg"

    const val METER_FORMAT = "%.1fm"

    const val STAT_FORMAT = "%d/255"

    const val PAGE_SIZE = 20

    const val DATABASE_NAME = "pokedex-app-db"
}